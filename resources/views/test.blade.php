                        ...
                        <div class="clearfix">
                            ...
                            <div class="col-xs-6 col-sm-4 col-md-3 col-lg-5-col no-padding box-hover-holder">
                                <label class="checkbox-holder">
                                    ...
                                    <span class="checkbox-icon"><i class="fa fa-check"></i></span>
                                    <span class="price_list" data-html="true" title="الاسعار" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-content=" <div class='price_list_show'>الايميل = 20</div><div class='thader_price'>تحاضير المستقبل = 100</div><div class='price_list_show'>سى دى = 20</div><div class='price_list_show'>طباعة ملونة وسي دي  = 100</div><div class='price_list_show'>طباعة عادية وسي دي = 50</div><div class='price_list_show'>تحضير الوزارة (عين) عام عادي  = 100</div><div class='price_list_show'>تحضير الوزارة (عين) عام ملون = 200</div><div class='price_list_show'>تحضير الوزارة (عين) مختصر عادي  = 70</div><div class='price_list_show'>تحضير الوزارة (عين) مختصر ملون = 140</div>"> توحيد </span>
 ...
 -->
            <!-- @if(auth()->check()) -->
            	...
            	<!-- <div class="text-center" style="margin-top: 0px;">
                	<a href="{{ route('materials.merge') }}" class="btn btn-green">ارسال الطلب</a>
            	</div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $.get('{{ route("levels.index")}}', function(res){
                    ...
                    $('#class_two > .table-cell > h1').text(res[0].display_name);
                    $('#class_three > .table-cell > h1').text(res[1].display_name);
                    $('#class_eight > .table-cell > h1').text(res[2].display_name);
                    $('#class_seven > .table-cell > h1').text(res[3].display_name);
                    $('#class_six > .table-cell > h1').text(res[4].display_name);
                    $('#class_one > .table-cell > h1').text(res[5].display_name);
                    $('#class_nine > .table-cell > h1').text(res[6].display_name);
                    $('#class_ten > .table-cell > h1').text(res[7].display_name);

                    for(let i = 9;i <= res.length; i++){

                        $('#chooseLevels').append(`

                            <div class="col-xs-12 col-sm-6 col-md-4 cd_shamla disapper">
                                <div class="class-section text-center orange-bg" id="${res[i].name}">
                                    <div class="table-cell">
                                        <h1 class="levelDisplayName">${res[i].display_name}</h1>
                                    </div>
                                    <div class="table-cell icon-cell">
                                        <div class="img-on-hover">
                                            <img src="{{asset('images/icon-10-hover.png')}}" alt="...">
            ...
            $.get('{{ route("years.index") }}', function(res){
                    ...
                    $('div.class-block > div.tabs-header > ul.nav-tabs > li > a').each(function(){
                    ...
                    $('div.class-block > div.tab-content > div.tab-pane').each(function(){

                        id = $(this).attr("id");

                        $(this).find('div.clearfix > div.col-xs-6 > label.checkbox-holder > input.subject_select').each(function(){

                            subjectsData.push($(this));

                        })

                        $(this).find('div.clearfix > div.col-xs-6 > label.checkbox-holder > span.price_list').each(function(){

                            $(this).text('');
                            $(this).attr("value", '#' + id);
                            subjectsArr.push($(this));
                    ...
                    // console.log(subjectsData[12].attr("class"));
                    res.forEach(function(year, k){

                        yearsArr[k].context.text = year.display_name;
            ...
            $('input.subject_select').on('change', function(e){
            ...
            $('#228').change(function(){
                ...
                //     // console.log(yearsArr[i].context.text);
                //     yearsArr[i].context.text = year.display_name;
                //     year.subjects.forEach(function(subject, k){

                //         // console.log(subjectsArr[k].text());
                //         console.log(year.id, subject.year_id);
                //         if(year.id == subject.year_id){
                //             subjectsArr[k].text(subject.display_name);
                //         }
                ...
                // console.log(res[0]);
                                    ...
                                    // console.log(subjectsArr[i].text());

                        // console.log(subjectsid[i]);


                        // console.log(subjectsid[i]);
                        // if(yearsHref[k] == subjectsid[i]){
